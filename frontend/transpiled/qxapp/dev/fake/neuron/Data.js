(function () {
  ...
  qx.Class.define("qxapp.dev.fake.neuron.Data", {
    ...
    statics: {
      ...
      getItemList: function getItemList(simSettingsId) {
        var itemList = qxapp.dev.fake.neuron.Data.itemList[simSettingsId];
      ...
      getItem: function getItem(simSettingsId, itemId) {
        return qxapp.dev.fake.neuron.Data.item[simSettingsId][itemId];
      } // statics

    }
  });
  qxapp.dev.fake.neuron.Data.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Data.js.map?dt=1568886163849