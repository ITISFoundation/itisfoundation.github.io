(function () {
  ...
  qx.Class.define("qxapp.dev.fake.materialDB.Data", {
    ...
    statics: {
      ...
      getItemList: function getItemList() {
        var itemList = qxapp.dev.fake.materialDB.Data.itemList;
        itemList.sort(this.compare);
        return itemList;
      },
      getItem: function getItem(materialId) {
  ...
  qxapp.dev.fake.materialDB.Data.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Data.js.map?dt=1568886163773