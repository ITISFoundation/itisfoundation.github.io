  ...
  ************************************************************************ */
  ...
  qx.Interface.define("qxapp.component.filter.IFilterable", {
    members: {
       ...
       */
      _filter: function _filter(data, msg) {
       ...
       * @param {qx.event.message.Message?} msg Incoming message containing the data.
       */
      _unfilter: function _unfilter(data, msg) {
        this.assertArgumentsCount(arguments, 0, 2);
       ...
       */
      _shouldReactToFilter: function _shouldReactToFilter(data, msg) {
       ...
       */
      _shouldApplyFilter: function _shouldApplyFilter(data, msg) {
        this.assertArgumentsCount(arguments, 1, 2);
  ...
  qxapp.component.filter.IFilterable.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=IFilterable.js.map?dt=1568886159902